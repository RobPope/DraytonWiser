...
import static org.openhab.binding.draytonwiser.DraytonWiserBindingConstants.THING_TYPE_ROOM;
...
public class DraytonWiserHandlerFactory extends BaseThingHandlerFactory {
    ...
    private static final Set<ThingTypeUID> SUPPORTED_THING_TYPES_UIDS = Collections.singleton(THING_TYPE_ROOM);
